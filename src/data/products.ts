...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 45.99,
    image: 'https://images.pexels.com/photos/2905667/pexels-photo-2905667.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  },
  {
    ...
    category: 'Kitchen',
    description: 'Compact espresso maker for rich, authentic coffee anywhere you go.',
    rating: 4.6,
    reviews: 203,
    inStock: true,
  },
  {
    ...
    category: 'Clothing',
    description: 'Sustainably made from 100% organic cotton with a comfortable, relaxed fit.',
    rating: 4.2,
    reviews: 167,
    inStock: true,
  },
  ...
  },
  {
    ...
    category: 'Electronics',
    description: 'High-precision gaming mouse with customizable RGB lighting and 12,000 DPI.',
    rating: 4.6,
    reviews: 278,
    inStock: true,
  },
